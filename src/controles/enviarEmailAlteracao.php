...
class Service {
	public function __construct()
    {
        ...
        $this->cript = new CriptografarSenha;
    }

    public function send($emailEsqueci){

        $stmUsuario = $this->tabUsuario->buscar_usuario($emailEsqueci);

        foreach ($stmUsuario as $dadosUsuario) {
            $codUrl = $this->cript->setCriptografarSenha($dadosUsuario['txt_cpf_usuario']);
