<?php
include("../../require/class/Tab_download_catDatec.class.php");
include("../../require/class/Tab_catalogoDatec.class.php");


$tabDownload = new Tab_download_catDatec;
$tabCatalogo = new Tab_catalogoDatec;
...
$consultaDownload = $tabDownload->consultar_downloadCatDatec($dados);
echo 'Result consulta: '.$consultaDownload.'<br><br>';
if($consultaDownload==0){ 
	$resultado = $tabDownload->cadastrar_downloadCatDatec($dados);
	if($resultado==0){
	...
	$resultado = $tabDownload->atualizar_downloadCatDatec($dados);
