...
<head>
  ...
  <script src="../../../_scripts/angular/app.js"></script>
	...
	<title>Sistema Convencional  - Novo</title>
 </head>
...
<body class="ng-scope" ng-controller="controlCadNovoConv"><!--controlCadNovoConv: Directiva que define o controlador na aplicação-->
	...
	<div class="container">
			...
			<div class="well">
				<form id="formularioCadNovoConv" method="post" enctype="multipart/form-data" action="../../controles/salvarNovoConvencional.php">
               ...
               <div class="form-group">
                    <div class="row">                        
                        ...
                        <div class="col-md-7">
                        	<br>
                            <label class="descricaoSolucao" id="descricaoSolucao"></label>
                         </div>   
                    </div>
               </div>
               <div id="dadosContato">
