...
<div class="container">
    ...
    <div id="comoPreencher" style="margin-top:5px">
        <p>Antes de acessar a área destinada ao download dos documentos de Especificações de Desempenho , será
            necessário cadastrar alguns dados para autenticação no sistema. Por favor preencha o formulário abaixo:</p>
    </div>
</div>
    ...
    <div class="well">
        <form id="formularioUsuario" method="post" action="../controles/salvarUsuario.php">
            <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                        <label for="pessoa">Tipo de Usuário:</label>
                    ...
                    <div class="col-md-4">
                        <input type="hidden" class="form-control" name="codPerfilUsuario" id="codPerfilUsuario"
                               value="2"/>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" maxlength="9" name="telefone"
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="cnpj" name="cnpj" placeholder="00000000000111"
                                   maxlength="14"/>
                        </div>

                        <div class="col-md-9">
                            <label class="control-label ">Razão Social</label>
                            <input type="text" class="form-control" name="razaoSocial" placeholder="Empresa do José"
                                   id="razaoSocial"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="cep" name="cep" placeholder="70000000"
                                   maxlength="8"
                            />
                        </div>
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="text" class="form-control" name="endereco" placeholder="Av. Paulista, Rua 10"
                                   id="endereco"/>
                        </div>
