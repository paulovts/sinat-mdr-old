    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8"> <!--COLUNA ESQUERDA-->
                ...
                <br>
                <p class="text-justify">Sistema Nacional de Avaliação Técnica de Sistemas Inovadores e Convencionais
                    empregados em empreendimentos habitacionais, baseado no conceito de desempenho. O SiNAT tem como
                    objetivo a harmonização de procedimentos para a avaliação técnica de Sistemas Inovadores e
                    Convencionais da Construção Civil no Brasil.</p><br>
            ...
            <div class="col-md-4"> <!--COLUNA DIREITA-->
                <div class="login">
                    ...
                    <form class="form-signin" method="post" action="	">
                        ...
                        <input type="text" id="usuario" name="usuario" class="form-control" placeholder="Email" required
                               autofocus>
                        <p class="erro hide" id="erroUsuario">Informe o usu&aacute;rio</p>
                        <br id="quebralinha1">
...
<div id="formularioModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-body">
                <div class="container">
                    <form id="frmEsqueciSenha" class="form-horizontal" method="post"
                          action="src/controles/enviarEmailAlteracao.php">
                        <div class="container">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-xs-7">
                                        <input type="text" id="emailEsqueci" name="emailEsqueci" class="form-control"
                                               placeholder="Informe o email cadastrado." required autofocus>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6" id="addButton">
                                        <br>
                                        <button type="submit" class="btn btn-info" id="btnEsqueciSenha"
...
<div id="footer">
    <div class="container">
        <a href="http://www.cidades.gov.br/" target="_blank"><H4>Minist&eacute;rio do Desenvolvimento Regional</h4></a>
