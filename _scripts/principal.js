    $(document).ready(function() {
        ...
        fields: {
            ...
            // Do something ...
			$.get("src/controles/consultarEmail.php?email="+emailEsqueci+"", function(resultado){
				...
				bootbox.dialog({
						  ...
						  buttons: {
							success: {
							  ...
							  callback: function() {
								fv.defaultSubmit(); // Retoma o envio normal para continuar para a alteracao
								bootbox.hideAll();
							  }
							}
						  }
...
$('#login').click(function() {
	...
	if ( usuarioDigitado == "" && senhaDigitada == "") {
		...
		$.get("src/seguranca/verificarDados.php?usuario="+ usuarioDigitado +"&senha="+ senhaDigitada +"", function(resultado){
					  if (resultado == 0) {
						  bootbox.dialog({
							  closeButton: false,
